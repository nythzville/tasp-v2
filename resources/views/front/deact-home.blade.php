        	...
        	<div class="collapse navbar-collapse" id="navigation-ea">
                ...
                @else
                    ...
                    @if(Auth::user()->user_type=='ADMIN')
                        <li class="btn btn-primary btn-main-nav"><a href="{{ url('admin/dashboard')}}">ADMIN</a></li>
                    @elseif(Auth::user()->user_type=='TEACHER')
                        <li class="btn btn-primary btn-main-nav"><a href="{{ url('teacher/profile')}}">MY ACCOUNT</a></li>
                    @elseif(Auth::user()->user_type=='STUDENT')
                        <li class="btn btn-primary btn-main-nav"><a href="{{ url('student/profile')}}">MY ACCOUNT</a></li>
                    @elseif(Auth::user()->user_type=='AGENT')
                        <li class="btn btn-primary btn-main-nav"><a href="{{ url('agent/profile')}}">MY ACCOUNT</a></li>
