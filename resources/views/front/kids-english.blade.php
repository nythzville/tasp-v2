...
<nav class="navbar navbar-transparent navbar-fixed-top navbar-color-on-scroll" role="navigation">
  ...
  <div class="main-nav">
    ...
    <div class="wrapper contact-page-banner">
      <div class="header header-filter parallax-section" style="background-image: url('{{ url('Elearn/Elearn/assets')}}/img/english-course/kid.jpg');">
          <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <h1 class="title" style="color:#ff6d04;">Kids English</h1>
                  <p>“Start young and learn early. Learning English is nothing but easy.”</p>
                </div>
              </div>
          </div>
      </div>
          ...
          <!-- <div class="container"> -->
            <div class="row">
              <div class="col-md-12">
                ...
                <p>  In EasyA, we help parents and guardians teach their child the fun and importance of the English language, and we prepare them for the future when English will be an important part of their child’s success. </p>

                <h3>Who should take this course?</h3>  
                <hr>
                <p>  This fun and entertaining course is specially created to capture the attention and interests of our young students in introducing the English language. It includes colorful illustrations, educational children’s books, lively songs and a ton of theme-based lessons for kids. The thematic teaching technique encourages young students to be active in class participation.</p>

                <h3>What you will learn?</h3>
                <hr>
                <p>  In this course, secondary to ensuring that the kids learn new vocabularies, proper intonation and pronunciation as well as grammar, the tutors’ goal is to coax young students to speak as much as they can. In that way, they get comfortable with the language faster and get rid of any inhibitions and overcome their shyness towards speaking with other people particularly strangers. </p>

                <p>  Our patient and enthusiastic Kids English teachers are ready to teach your child’s fundamental English knowledge and guide their fluency, pronunciation and grammar while they are still young.</p>

                <p>  Try us and witness your child’s advancement as they ace their English exams or comfortably use their communication skills to talk with a foreigner and even a native English speaker.</p>
                </div>
